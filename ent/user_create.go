...
func (uc *UserCreate) AddSentOrderIDs(ids ...int) *UserCreate {
	uc.mutation.AddSentOrderIDs(ids...)
	return uc
}

// AddSentOrders adds the "sent_orders" edges to the Order entity.
func (uc *UserCreate) AddSentOrders(o ...*Order) *UserCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uc.AddSentOrderIDs(ids...)
}

// AddReceivedOrderIDs adds the "received_orders" edge to the Order entity by IDs.
func (uc *UserCreate) AddReceivedOrderIDs(ids ...int) *UserCreate {
	uc.mutation.AddReceivedOrderIDs(ids...)
	return uc
}

// AddReceivedOrders adds the "received_orders" edges to the Order entity.
func (uc *UserCreate) AddReceivedOrders(o ...*Order) *UserCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return uc.AddReceivedOrderIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.SentOrdersIDs(); len(nodes) > 0 {
	...
	if nodes := uc.mutation.ReceivedOrdersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
